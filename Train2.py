from baseline.dataset_segmentation import DatasetSegmentation
...
def get_dataloader(img_size=512, batch_size=2):
    ...
    train_set = DatasetSegmentation("./dataset/train/pos", tf_train) # Train *change
    val_set = DatasetSegmentation("./dataset/val/pos", tf_val) # Val *change
